<template>
  ...
  >
    ...
    <div
      :style="`font-size:${textFormat.lastName.font_size * 2.05}px; bottom: ${
    ...
    <div
      style="
        ...
        position: absolute;
      "
      :style="`font-size:${textFormat.position.font_size * 2.05}px; bottom: ${
        textFormat.position.bottom * 2.23
      }px;
        left: ${textFormat.position.left * 2}px; line-height: ${
        textFormat.position.line_height * 2
      }px;`"
    >
      {{ details.position }}
    </div>
