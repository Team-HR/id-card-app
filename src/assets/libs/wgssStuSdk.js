...
WacomGSS.STUConstructor = (function () {
  ...
  function receive(message) {
    if (typeof message.data !== "undefined" && message.data != "") {
      ...
      if (checkExists(arg.ticket) && checkExists(table[arg.ticket])) {
        if (
          checkExists(arg.success) &&
          true == arg.success &&
          checkExists(arg.data)
        ) {
          table[arg.ticket].resolve(arg.data);
        } else {
          table[arg.ticket].reject(
            new Error(checkExists(arg.error) ? arg.error : "")
          );
        }
        delete table[arg.ticket];
      } else if (
        checkExists(arg.stream) &&
        checkExists(stream[arg.stream]) &&
        checkExists(arg.data)
      ) {
  ...
  STU.prototype.getStringUsbDevice = function (usbDevice) {
    ...
    return (
      get4DigitsHex(usbDevice.idVendor) +
      ":" +
  ...
  STU.prototype.Protocol = (function () {
    ...
    Protocol.prototype.OperationMode_SlideShow = (function () {
      function OperationMode_SlideShow(
        workingMode,
        numberOfSlides,
        slideNumber,
        interval
    ...
    Protocol.prototype.OperationMode_Signature = (function () {
      function OperationMode_Signature(
        signatureScreen,
        keyDefinition,
        idAfterEnter,
        idAfterCancel
    ...
    Protocol.prototype.RomStartImageData_PinPad = (function () {
      ...
      // keyLayout    1..5
      function RomStartImageData_PinPad(
        encodingMode,
        imageType,
        imageNumber,
        padType,
    ...
    Protocol.prototype.RomStartImageData_SlideShow = (function () {
      ...
      // imageType    not used
      // imageNumber  1..10
      function RomStartImageData_SlideShow(
        encodingMode,
        imageType,
        imageNumber
      ) {
    ...
    Protocol.prototype.RomStartImageData_KeyPad = (function () {
      ...
      function RomStartImageData_KeyPad(
        encodingMode,
        imageType,
        imageNumber,
        padType,
        ...
        this.data[2] =
          (keyEnabled.length > 7 && keyEnabled[7] ? 0x80 : 0) |
    ...
    Protocol.prototype.RomStartImageData_Signature = (function () {
      ...
      // imageNumber  1..3
      // keyEnabled
      function RomStartImageData_Signature(
        encodingMode,
        imageType,
        imageNumber,
        keyEnabled
    ...
    Protocol.prototype.setRomImageHash = function (
      operationModeType,
      imageType,
      imageNumber
    ) {
    ...
    Protocol.prototype.setRomImageDelete = function (
      romImageDeleteMode,
      imageType,
      imageNumber
    ) {
    ...
    Protocol.prototype.setRomImageDisplay = function (
      operationModeType,
      imageType,
      imageNumber
    ) {
    ...
    Protocol.prototype.setHandwritingThicknessColor = function (
    ...
    Protocol.prototype.setHandwritingThicknessColor24 = function (
    ...
    Protocol.prototype.setHandwritingDisplayArea = function (
    ...
    Protocol.prototype.EncryptionCommand = (function () {
      ...
      EncryptionCommand.prototype.initializeSetEncryptionType = function (
        symmetricKeyType,
      ...
      EncryptionCommand.prototype.initializeSetParameterBlock = function (
        index,
        data
      ) {
        return WacomGSS.STU.send({
      ...
      EncryptionCommand.prototype.initializeGetParameterBlock = function (
        index,
        offset
      ) {
        return WacomGSS.STU.send({
    ...
    Protocol.prototype.getEncryptionCommand = function (
  ...
  STU.prototype.ProtocolHelper = {
    ReportHandler: (function () {
      ...
      ReportHandler.prototype.startReporting = function (
        _interfaceQueueHolder,
        tabletDecrypt
      ) {
      ...
      ReportHandler.prototype.onEventDataEncrypted = function (
        protocol,
        message
      ) {
        switch (message.operationModeType) {
      ...
      function myLoop() {
        protocol
          ...
          .then(function (status) {
            return WacomGSS.STU.ProtocolHelper.statusCanSend(
              status.statusCode,
              reportId,
              opDirection
            );
    ...
    waitForStatus: function (
      ...
      var deferred = Q.defer();
      function myLoop() {
        protocol.getStatus().then(function (status) {
    ...
    supportsEncryption: function (protocol) {
      ...
      return WacomGSS.STU.ProtocolHelper.waitForStatusToSend(
        protocol,
        WacomGSS.STU.Protocol.ReportId.ReportId_DHprime,
        opDirection,
        25,
        50
      ).then(function (message) {
    ...
    // retries is an Integer
    // sleepBetweenRetries is an Integer (milliseconds)
    setHostPublicKeyAndPollForDevicePublicKey: function (
      protocol,
      hostPublicKey,
      retries,
      sleepBetweenRetries
      ...
      return protocol
        ...
        .then(function (message) {
          var opDirection =
            WacomGSS.STU.ProtocolHelper.OpDirection.OpDirection_Get;
          return WacomGSS.STU.ProtocolHelper.waitForStatusToSend(
            protocol,
            WacomGSS.STU.Protocol.ReportId.ReportId_DevicePublicKey,
            opDirection,
            retries,
            sleepBetweenRetries
          );
    ...
    writeImage: function (
      ...
      sleepBetweenRetries =
        typeof sleepBetweenRetries === "undefined" ? 25 : sleepBetweenRetries;
      var opDirection = WacomGSS.STU.ProtocolHelper.OpDirection.OpDirection_Set;
      return WacomGSS.STU.ProtocolHelper.waitForStatusToSend(
        protocol,
        WacomGSS.STU.Protocol.ReportId.ReportId_StartImageData,
        opDirection,
        retries,
        sleepBetweenRetries
      )
        ...
        .then(function (message) {
          ...
          return WacomGSS.STU.ProtocolHelper.writeImageCommon(
            protocol,
            encodingMode,
            maxImageBlockSize,
            imageData,
    ...
    writeImageCommon: function (
      ...
      return WacomGSS.STU.ProtocolHelper.waitForStatusToSend(
        protocol,
        WacomGSS.STU.Protocol.ReportId.ReportId_ImageDataBlock,
        opDirection,
        retries,
        sleepBetweenRetries
      ).then(function (message) {
    ...
    flatten: function (
      ...
      switch (encodingMode) {
        ...
        case p.EncodingMode.EncodingMode_24bit_Bulk:
          return WacomGSS.STU.ProtocolHelper.flattenColor24(
            b64Data,
            screenWidth,
            screenHeight,
            dataStore
        ...
        case p.EncodingMode.EncodingMode_16bit_Bulk:
          return WacomGSS.STU.ProtocolHelper.flattenColor16(
            b64Data,
            screenWidth,
            screenHeight,
            dataStore
        ...
        case p.EncodingMode.EncodingMode_1bit_Bulk:
          return WacomGSS.STU.ProtocolHelper.flattenMonochrome(
            b64Data,
            screenWidth,
            screenHeight,
            dataStore
    ...
    generateSymmetricKeyAndWaitForEncryptionStatus: function (
      protocol,
      retries,
      sleepBetweenRetries,
      timeout
  ...
  STU.prototype.Tablet = (function () {
    ...
    Tablet.prototype.Constructor = function (
      intf,
      encryptionHandler,
      encryptionHandler2
    ) {
      return WacomGSS.STU.send({
        ...
        encryptionHandler:
          "undefined" === typeof encryptionHandler || null === encryptionHandler
            ? null
            : encryptionHandler.toJSON(),
        encryptionHandler2:
          "undefined" === typeof encryptionHandler2 ||
          null === encryptionHandler2
            ? null
            : encryptionHandler2.toJSON(),
      }).then(function (message) {
        id = message.id;
        return message;
      });
    ...
    // handwritingThicknessColor type is Protocol.HandwritingThicknessColor
    Tablet.prototype.setHandwritingThicknessColor = function (
      handwritingThicknessColor
    ) {
      return WacomGSS.STU.send({
        scope: scope,
    ...
    // handwritingThicknessColor24 type is Protocol.HandwritingThicknessColor24
    Tablet.prototype.setHandwritingThicknessColor24 = function (
      handwritingThicknessColor24
    ) {
      return WacomGSS.STU.send({
        scope: scope,
    ...
    // handwritingDisplayArea type is Protocol.Rectangle
    Tablet.prototype.setHandwritingDisplayArea = function (
      handwritingDisplayArea
    ) {
      return WacomGSS.STU.send({
        scope: scope,
    ...
    Tablet.prototype.decrypt = function (data) {
      return WacomGSS.STU.send(
        // return the decrypted 16-byte array
        {
          scope: scope,
          id: id,
          decrypt: "decrypt",
    ...
    Tablet.prototype.setRomImageHash = function (
      operationModeType,
      imageType,
      imageNumber
    ) {
    ...
    // imageType    false=not pushed; true=pushed
    // imageNumber  1..10 depending on delete mode
    Tablet.prototype.setRomImageDelete = function (
      romImageDeleteMode,
      imageType,
      imageNumber
    ) {
    ...
    // imageType    false=not pushed; true=pushed
    // imageNumber  1..10 depending on operation mode
    Tablet.prototype.setRomImageDisplay = function (
      operationModeType,
      imageType,
      imageNumber
    ) {
  ...
  STU.prototype.EncryptionHandler2 = (function () {
    ...
    details.getParameters = function (message) {
      var tuple = m_impl.getParameters(
        message.data.symmetricKeyType,
        message.data.asymmetricPaddingType,
        message.data.asymmetricKeyType
      );
